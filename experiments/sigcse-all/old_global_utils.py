...
def LM_correction_low(input_text, temperature):
...
@backoff.on_exception(backoff.expo, (requests.exceptions.RequestException, Exception), max_tries=10, on_backoff=backoff_hdlr)
def LM_correction_medium(input_text, temperature):
    # print("Into the post process gpt function")
    messages = [
        {
            "role": "system",
...
@backoff.on_exception(backoff.expo, (requests.exceptions.RequestException, Exception), max_tries=10, on_backoff=backoff_hdlr)
def LM_correction_high(input_text, temperature):
    # print("Into the post process gpt function")
    messages = [
        {
            "role": "system",
...
@backoff.on_exception(backoff.expo, (requests.exceptions.RequestException, Exception), max_tries=10, on_backoff=backoff_hdlr)
def LM_correction_low_chris(input_text, temperature):
    # print("Into the post process gpt function")
    messages = [
        {
            "role": "system",
...
@backoff.on_exception(backoff.expo, (requests.exceptions.RequestException, Exception), max_tries=10, on_backoff=backoff_hdlr)
def LM_line(line, entire_code, temperature=0.2):
    # print("Into the post process gpt function")
    messages = [
        {
            "role": "system",
